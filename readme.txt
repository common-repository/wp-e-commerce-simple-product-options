...
Note: This plugin is no longer supported. The plugin is available for forking and contribution over on [GitHub](https://github.com/ademti-software/wp-e-commerce-simple-product-options/).
